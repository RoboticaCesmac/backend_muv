...
class UsersSheet implements FromCollection, WithHeadings, WithTitle
{
    ...
    public function collection(): Collection
    {
        $data = Route::select(
            ...
            DB::raw('COALESCE(SUM(routes.carbon_produced), 0) as total_carbon_produced'),
        ...
        $fields = [
            ...
            'Total de Carbono Gerado(kg CO2)' => 'total_carbon_produced',
            'Total de Carbono Economizado(kg CO2)' => 'total_carbon_footprint',
            'Total de Pontos' => 'total_points',
            'Média de Carbono por Rota(kg CO2/KM)' => 'average_carbon_footprint',
            'Média de Distância por Rota(KM)' => 'average_distance',
