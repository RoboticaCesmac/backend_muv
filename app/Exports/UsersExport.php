...
class UsersSheet implements FromCollection, WithHeadings, WithTitle
{
    ...
    public function collection(): Collection
    {
        ...
        $fields = [
            ...
            'Total de Carbono Gerado(gCO2)' => 'total_carbon_produced',
            'Total de Carbono Economizado(gCO2)' => 'total_carbon_saved',
            'Total de Pontos' => 'total_points',
            'Média de Carbono por Rota(gCO2/KM)' => 'average_carbon_footprint',
